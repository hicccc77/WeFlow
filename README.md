...
| Linux | ARM64 / aarch64 设备 | `.AppImage`、`.tar.gz`，见 [Linux ARM64 支持说明](docs/LINUX-ARM64.md) |
...
| Linux | ARM64 / aarch64 devices | `.AppImage`, `.tar.gz`; see [Linux ARM64 notes](docs/LINUX-ARM64.md) |
